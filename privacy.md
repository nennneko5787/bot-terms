# プライバシーポリシー
CuteCat Studio（以下，「当団体」といいます。）は，本Discordボット上で提供するサービス（以下，「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
...
Discord: `pjcd`  
Email address: `h4369 (at) nennneko5787 (dot) net`  
(at) を @ 、 (dot) を . に置き換えてください。

2025/12/06 Discordのユーザーネームを変更したため修正  
2024/10/15 全ボット向けに書き直し  
